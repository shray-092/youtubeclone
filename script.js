...
//             "x-rapidapi-key":"6b54df7548msh65d9dd38e35c610p1f11a8jsna8403d638c2a",
//         },
...
const show=(list)=>{
    list.forEach((e,idx)=> {
        ...
        newcard.addEventListener("click",()=>{
            window.open(`./video.html?id=${e.videoId}`)
        })
        newcard.style.backgroundColor="black";
        newcard.innerHTML=`
        <img src='${e.videoThumbnails[0].url}'
        width="100%" onmouseover="hover1(event,${idx})">
        <h6 style="color:white">${e.author}</h6>
...
const handleSearch = (e) => {
    ...
    const filtered = dummyData.filter(video => 
